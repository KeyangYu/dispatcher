...
CLIENT_PORT = 9092  # Unique port for each client. Replace X with the client number.
...
if __name__ == "__main__":
    ...
    while True:
        if wait_for_start_signal():
            ...
            data, target = proxy.get_cifar(f"client2")  # Replace X with the client number
            ...
            with open(model_name, "rb") as model_file:
                proxy.upload_model(xmlrpc.client.Binary(model_file.read()), f"client2")  # Replace X with the client number

...
CLIENT_PORT = 9091  # Unique port for each client
    ...
    while True:
        if wait_for_start_signal():
            ...
            with xmlrpc.client.ServerProxy("http://localhost:9090/RPC2") as proxy:
                ...
                data, target = proxy.get_mnist("client1")  # Passing client ID
                ...
                with open('trained_model.pkl', 'rb') as model_file:
                    proxy.upload_model(xmlrpc.client.Binary(model_file.read()), "client1")
